classdef GreenwoodPowerLaw < PowerLaw
   ...
   methods
       function obj = GreenwoodPowerLaw(varargin)
       % constructors
       % 1. obj = GreenwoodPowerLaw() Null constructor
       % 2. obj = GreenwoodPowerLaw(VonKarmanPowerLaw) copy constructor
       % 3. obj = GreenwoodPowerLaw(double exponent, double coeff, double outscale) 
       % 4. obj = GreenwoodPowerLaw(double exponent, double r0_meters, double
       ...
       function result = value(obj, spatialfrequency)
          ...
          result = obj.coefficient * ((spatialfrequency.*(spatialfrequency+2*pi/obj.outerscalevalue)).^(obj.exponent/2)); 
       end
       ...
       function result = eq(a,b)
          if isa(a, 'GreenwoodPowerLaw') && isa(b, 'GreenwoodPowerLaw')
